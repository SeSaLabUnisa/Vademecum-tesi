...
5. `Minacce alla Validità` (solo Magistrali). Qui si presentano le minacce alla validità del lavoro di tesi, ovvero tutti quei fattori che potrebbero inficiare la correttezza e l'affidabilità del lavoro di ricerca. Ad esempio, l'aver condotto le analisi soltanto sui sistemi Java non permette di generalizzare i risultati anche nei sistemi Python. Non è facile identificare le minacce alla validità se si è alle prime armi: **è normale sbagliare**. Tuttavia, non aver paura di provare, è un ottimo allenamento per formare la mentalità della ricerca. Pertanto, raccomandiamo alcune letture che possono aiutare a prendere familiarità con questi concetti: (1) il materiale del corso di *Metriche e Qualità del Software (del Prof. Gravino)* (accessibile liberamente sulla piattaforma e-learning), (2) [Capitolo del Libro "Empirical Research for Software Security" di ben Othmane](https://sintef.brage.unit.no/sintef-xmlui/bitstream/handle/11250/2470488/SINTEF_ESORICS_STM_2017.pdf?sequence=1) (il libro pone l'attenzione alla software security, ma in realtà il contenuto di questo capitolo è applicabile a tutta la ricerca di ingegneria del software empirica) e (3) le guide di *Cojointly*:
   - https://conjointly.com/kb/single-group-threats/
   - https://conjointly.com/kb/multiple-group-threats/
   - https://conjointly.com/kb/social-interaction-threats/
   - https://conjointly.com/kb/conclusion-validity-threats/
   - https://conjointly.com/kb/external-validity/#threats-to-external-validity
   - https://conjointly.com/kb/construct-validity-threats/
7. `Conclusioni`. Qui si riassume quanto è stato fatto, i risultati principali ottenuti e dell'impatto del lavoro (quanto è utile per gli altri?). Dopodiché, si parla anche di cosa non è stato fatto e di quanto ancora c'è da fare nell'ambito scelto (i cosiddetti, sviluppi futuri).
